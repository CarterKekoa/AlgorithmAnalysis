...
TEST(AdjacencyListTest, MyBasicPositiveWeightBellmanFordShortesPath) {
  AdjacencyList g(5);
  g.set_edge(0, 1, 1);
  g.set_edge(1, 1, 2);
  g.set_edge(2, 1, 3);
...
TEST(AdjacencyListTest, MyBasicNegativeWeightBellmanFordShortesPath) {
  AdjacencyList g(4);
  g.set_edge(0, 6, 1);
  g.set_edge(0, -2, 2);
  g.set_edge(1, 4, 0);
  ...
  // check path costs
  ASSERT_EQ(0, path_costs[0]);
  ASSERT_EQ(-5, path_costs[1]);
  ASSERT_EQ(-6, path_costs[2]);
  ASSERT_EQ(-4, path_costs[3]);
}
...
// TODO: Add two additional shortest path tests
TEST(AdjacencyMatrixTest, MyBasicPositiveWeightBellmanFordShortesPath) {
  AdjacencyMatrix g(5);
  g.set_edge(0, 1, 1);
  g.set_edge(1, 1, 2);
  g.set_edge(2, 1, 3);
...
TEST(AdjacencyMatrixTest, MyBasicNegativeWeightBellmanFordShortesPath) {
  AdjacencyMatrix g(4);
  g.set_edge(0, 6, 1);
  g.set_edge(0, -2, 2);
  g.set_edge(1, 4, 0);
