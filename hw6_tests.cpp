...
TEST(AdjacencyListTest, MyHamiltonianPath) {
  AdjacencyList g(7);
  g.set_edge(0, 0, 1);
  g.set_edge(1, 0, 2);
  g.set_edge(2, 0, 3);
...
TEST(AdjacencyListTest, MyHamiltonianPath2) {
  AdjacencyList g(4);
  g.set_edge(0, 0, 1);
  g.set_edge(1, 0, 3);
  g.set_edge(3, 0, 2);
...
TEST(AdjacencyListTest, MyBasicGraphMatchingBook) {
  AdjacencyList g(6);
  g.set_edge(0, 0, 4);
  g.set_edge(1, 0, 3);
  g.set_edge(2, 0, 4);
  ...
  ASSERT_EQ(true, m.has_edge(1, 3) or m.has_edge(3, 1));
  ASSERT_EQ(true, m.has_edge(2, 4) or m.has_edge(4, 2));
  ASSERT_EQ(true, m.has_edge(0, 5) or m.has_edge(5, 0));
}

TEST(AdjacencyListTest, MyBasicGraphMatchingBook2) {
  AdjacencyList g(6);
  g.set_edge(0, 0, 1);
  g.set_edge(0, 0, 2);
  g.set_edge(0, 0, 3);
  ...
  ASSERT_EQ(3, m.edge_count());
  ASSERT_EQ(true, m.has_edge(0, 3) or m.has_edge(3, 0));
  ASSERT_EQ(true, m.has_edge(1, 4) or m.has_edge(4, 1));
  ASSERT_EQ(true, m.has_edge(2, 5) or m.has_edge(5, 2));
}
...
TEST(AdjacencyListTest, MyBasicClique) {
  AdjacencyList g(6);
  g.set_edge(0, 0, 1);
  g.set_edge(0, 0, 5);
  g.set_edge(1, 0, 5);
  ...
  list<Set> cliques;
  g.cliques(cliques);
  ASSERT_EQ(3, cliques.size());
  ASSERT_EQ(true, contains_clique(cliques, Set {0,1,5}));
  ASSERT_EQ(true, contains_clique(cliques, Set {1,2,4,5}));
  ASSERT_EQ(true, contains_clique(cliques, Set {2,3,4}));  
}

TEST(AdjacencyListTest, MyBasicClique2) {
  AdjacencyList g(7);
  g.set_edge(0, 0, 1);
  g.set_edge(0, 0, 2);
  g.set_edge(0, 0, 3);
  ...
  ASSERT_EQ(true, contains_clique(cliques, Set {4,6}));
  ASSERT_EQ(true, contains_clique(cliques, Set {3,5}));
}
...
// TODO: Add at least two addition hamiltonian path tests
TEST(AdjacencyMatrixTest, MyHamiltonianPath) {
  AdjacencyMatrix g(7);
  g.set_edge(0, 0, 1);
  g.set_edge(1, 0, 2);
  g.set_edge(2, 0, 3);
...
TEST(AdjacencyMatrixTest, MyHamiltonianPath2) {
  AdjacencyMatrix g(4);
  g.set_edge(0, 0, 1);
  g.set_edge(1, 0, 3);
  g.set_edge(3, 0, 2);
...
// TODO: Add at least two addition graph matching tests
TEST(AdjacencyMatrixTest, MyBasicGraphMatchingBook) {
  AdjacencyMatrix g(6);
  g.set_edge(0, 0, 4);
  g.set_edge(1, 0, 3);
  g.set_edge(2, 0, 4);
...
TEST(AdjacencyMatrixTest, MyBasicGraphMatchingBook2) {
  AdjacencyMatrix g(6);
  g.set_edge(0, 0, 1);
  g.set_edge(0, 0, 2);
  g.set_edge(0, 0, 3);
  ...
  ASSERT_EQ(true, m.has_edge(0, 3) or m.has_edge(3, 0));
  ASSERT_EQ(true, m.has_edge(2, 4) or m.has_edge(4, 2));
  ASSERT_EQ(true, m.has_edge(1, 5) or m.has_edge(5, 1));
}
...
// TODO: Add at least two addition clique tests
TEST(AdjacencyMatrixTest, MyBasicClique) {
  AdjacencyMatrix g(6);
  g.set_edge(0, 0, 1);
  g.set_edge(0, 0, 5);
  g.set_edge(1, 0, 5);
...
TEST(AdjacencyMatrixTest, MyBasicClique2) {
  AdjacencyMatrix g(7);
  g.set_edge(0, 0, 1);
  g.set_edge(0, 0, 2);
  g.set_edge(0, 0, 3);
